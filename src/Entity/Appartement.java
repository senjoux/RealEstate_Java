...
public class Appartement extends BienImmobilier {
    ...
    //meme que villa mais la valeur de jardin =0 et on ajoute les champs ascenceur+ etage    
    ...
    //avec id
    public Appartement(int id, float surface, String etat, Adresse adresse,String descritpion, int nbr_piece,
                int cuisineEquipe, int gaz_de_ville,int chauffage, int meuble,int climatisation,
                int ascenceur, int etage) {
        super(id, surface, etat, adresse);
        this.typeImmob="Appartement";
    ...
    public Appartement( float surface, String etat, Adresse adresse,String descritpion,int nbr_piece,
