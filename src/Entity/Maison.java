...
public class Maison extends BienImmobilier{
    ...
    public Maison() {
     ...
     //avec id
    public Maison(int id, float surface, String etat, Adresse adresse,String descritpion, int nbr_piece,int jardin,
    ...
    public Maison( float surface, String etat, Adresse adresse,String descritpion,int nbr_piece,int jardin,
