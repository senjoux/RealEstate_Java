 ...
 * @author ShujiX
 */
public class AdresseAdapterInstant extends AbstractTableModel{
    
    List<Adresse> adresses; 
    String []header={"ID Adresse","Gouvernorat","CodePostal","Ville"};
        
    public AdresseAdapterInstant(String ch){
         adresses = new AdresseDAO().findInstant(ch);
    }

    public AdresseAdapterInstant(List<Adresse> adresses) {
