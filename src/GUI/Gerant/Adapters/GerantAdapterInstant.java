 ...
 * @author ShujiX
 */
public class GerantAdapterInstant extends AbstractTableModel{
    List<Gerant> gerants; 
        String []header={"ID Gerant","Mail","Password","Nom","Prenom","NumMobile","NumFix"}; 

    public GerantAdapterInstant(String ch) {
        gerants = new GerantDAO().findInstant(ch);
    }
    
    
    public GerantAdapterInstant(List<Gerant> gerants) {
