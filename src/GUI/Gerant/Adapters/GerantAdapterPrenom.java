 ...
 * @author ShujiX
 */
public class GerantAdapterPrenom extends AbstractTableModel{
     List<Gerant> gerants; 
        String []header={"ID Gerant","Mail","Password","Nom","Prenom","NumMobile","NumFix"}; 

    public GerantAdapterPrenom() {
        gerants = new GerantDAO().displayAllTriePrenom();
    }
    
    
    public GerantAdapterPrenom(List<Gerant> gerants) {
