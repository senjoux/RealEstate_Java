...
public class ClientAdapter3 extends AbstractTableModel 
{
  List<Client> clients ;
    
    String []header = {"Id","Nom","Prenom","Mail","Password","statusMatrimonial"};
    
    public ClientAdapter3() {

        clients = new ClientDAO().TrierParPrenom();
    }

    public ClientAdapter3(List<Client> clients) {
