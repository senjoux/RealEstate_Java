...
public class ClientAdapter4 extends AbstractTableModel 
{
  List<Client> clients ;
    
    String []header = {"Id","Nom","Prenom","Mail","Password","statusMatrimonial"};
    
    public ClientAdapter4() {

        clients = new ClientDAO().TrierParMail();
    }

    public ClientAdapter4(List<Client> clients) {
