...
public class ClientAdapter5 extends AbstractTableModel 
{
  List<Client> clients ;
    
    String []header = {"Id","Nom","Prenom","Mail","Password","statusMatrimonial"};
    
    public ClientAdapter5() {

        clients = new ClientDAO().TrierParPassword();
    }

    public ClientAdapter5(List<Client> clients) {
