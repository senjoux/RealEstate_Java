...
public class ClientAdapter6 extends AbstractTableModel 
{
  List<Client> clients ;
    
    String []header = {"Id","Nom","Prenom","Mail","Password","statusMatrimonial"};
    
    public ClientAdapter6(String ch) {

        clients = new ClientDAO().findClientByNom(ch);
    }

    public ClientAdapter6(List<Client> clients) {
